...
private final String URL_LIST="/AdminPanel/Products/List/";
            ...
            throws ServletException, IOException, SQLException, ClassNotFoundException, DoesntExistException
    {
        ...
        {
            response.sendRedirect(URL_LIST+product+"/"+"v"+value+"?att=empty");
            return;
        }
            
        if(!Methods.Methods.isNumber(price))
        {
            response.sendRedirect(URL_LIST+product+"/"+"v"+value+"?att=number");
            return;
        }
        ...
        if(productSQL.packageNameExists(valueId, name))
        {
            response.sendRedirect(URL_LIST+product+"/"+"v"+value+"?att=nameExists");
            return;
        }
        ...
        productSQL.addScalePackage(valueId, name, description, picture, priceVal);
        response.sendRedirect(URL_LIST+product+"/"+"v"+value+"?att=ok");
        return;
    }
