 ...
 * @author Moses
 */
public class SetSmsConfig extends HttpServlet {
...
private final String URL_LOGIN="/AdminPanel/Login.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SetSmsConfig</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SetSmsConfig at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
            ...
            throws ServletException, IOException, SQLException, ClassNotFoundException, DoesntExistException
    {
        ...
        HashMap<String,String> smsConfigs=new Parameters.SmsConfigs().getSmsConfig();
        LinkedList<String> configs=new LinkedList<String>();
        for(String key:smsConfigs.keySet())
        {
