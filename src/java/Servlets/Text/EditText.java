...
private final String URL_SHOW_TEXT="List/";
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EditText</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet EditText at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
            ...
            throws ServletException, IOException, SQLException, ClassNotFoundException, DoesntExistException, NoSuchAlgorithmException
    {
        ...
        {
            response.sendRedirect(URL_SHOW_TEXT+textid+"?att=empty");
            return;
        }
        ...
        comSQL.updateText(textId, subject, link, text, statusVal);
        response.sendRedirect(URL_SHOW_TEXT+textid+"?att=ok");
        return;
    }
