 ...
 * @author Moses
 */
public class DeletePartner extends HttpServlet {
...
private final String URL_PARTNERS_LIST="Partners.jsp";
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DeletePartner</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet DeletePartner at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
            ...
            throws ServletException, IOException, SQLException, ClassNotFoundException, DoesntExistException, NoSuchAlgorithmException
    {
        ...
        partnerSQL.deletePartner(partnerId);
        response.sendRedirect(URL_PARTNERS_LIST+"?att=ok");
        return;
