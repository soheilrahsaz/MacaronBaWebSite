 ...
 * @author Moses
 */
public class EditPartnerProduct extends HttpServlet {
...
private final String URL_SHOW_PRODUCT="Products/";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EditPartnerProduct</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet EditPartnerProduct at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
            ...
            throws ServletException, IOException, SQLException, ClassNotFoundException, DoesntExistException, NoSuchAlgorithmException
    {
        ...
        partnerSQL.updatePartnerProduct(productId, categoryId, name, priceVal, countVal, description, statusVal);
        response.sendRedirect(URL_SHOW_PRODUCT+product+"?att=ok");
        return;
    }
}
