 ...
 * @author Moses
 */
public class AddPartnerSeries extends HttpServlet {
private final String URL_INDEX="/AdminPanel/index.jsp";
private final String URL_ADMIN_LOGIN="../Login.jsp";
private final String URL_ADD_SERIES="PartnerSeries.jsp";
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AddPartnerSeries</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AddPartnerSeries at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
            ...
            throws ServletException, IOException, SQLException, ClassNotFoundException, DoesntExistException, NoSuchAlgorithmException
    {
        ...
        {
            response.sendRedirect(URL_ADD_SERIES+"?att=empty");
            return;
        }
        double effectVal=Double.parseDouble(effect);
        
        PartnerSQLCommands partnerSQL=new PartnerSQLCommands(connection);
        partnerSQL.addPartnerSeries(name, effectVal);
        response.sendRedirect(URL_ADD_SERIES+"?att=ok");
            return;
