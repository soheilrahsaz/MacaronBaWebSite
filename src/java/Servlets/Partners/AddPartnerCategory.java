 ...
 * @author Moses
 */
public class AddPartnerCategory extends HttpServlet {
private final String URL_INDEX="/AdminPanel/index.jsp";
private final String URL_ADMIN_LOGIN="../Login.jsp";
private final String URL_ADD_CATEGORY="Categories.jsp";
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AddPartnerCategory</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AddPartnerCategory at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
            ...
            throws ServletException, IOException, SQLException, ClassNotFoundException, DoesntExistException, NoSuchAlgorithmException
    {
        ...
        {
            response.sendRedirect(URL_ADD_CATEGORY+"?att=empty");
            return;
        }
        
        PartnerSQLCommands partnerSQL=new PartnerSQLCommands(connection);
        partnerSQL.addPartnerCategory(name);
        response.sendRedirect(URL_ADD_CATEGORY+"?att=ok");
        return;
    }
}
