...
private final String URL_SHOW_VIDEO="Videos/";
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EditVideo</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet EditVideo at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
            ...
            throws ServletException, IOException, SQLException, ClassNotFoundException, DoesntExistException
    {
        ...
        if(!admin.haveAccessTo("editVideo"))
        {
        ...
        {
            response.sendRedirect(URL_SHOW_VIDEO+videoid+"?att=empty");
            return;
        }
        ...
        siteSQL.editVideo(videoId, name, description, tags, sectionId, statusId);
        response.sendRedirect(URL_SHOW_VIDEO+videoid+"?att=ok");
        return;
