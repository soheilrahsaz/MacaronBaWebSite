...
private final String URL_ADD_VIDEO="Upload.jsp";
    /**
            ...
            throws ServletException, IOException, SQLException, ClassNotFoundException, DoesntExistException
    {
        ...
        {
            response.sendRedirect(URL_ADD_VIDEO+"?att=empty");
            return;
        }
        ...
        {
            response.sendRedirect(URL_ADD_VIDEO+"?att=nofile");
            return;
        }
        ...
        int videoId=siteSQL.addVideo(newFileName, name, description, tags, sectionId, admin.getAdminId(), 1,1);
        response.sendRedirect(URL_ADD_VIDEO+"?att=ok");
        return;
