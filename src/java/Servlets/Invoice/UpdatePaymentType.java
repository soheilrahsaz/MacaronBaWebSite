 ...
 * @author Moses
 */
public class UpdatePaymentType extends HttpServlet {
private final String URL_LOGIN="/AdminPanel/Login.jsp";
private final String URL_PAYMENT_TYPES="/AdminPanel/Invoice/PaymentTypes.jsp";
private final String URL_INDEX="/AdminPanel/index.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet UpdatePaymentType</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet UpdatePaymentType at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
            ...
            throws ServletException, IOException, SQLException, ClassNotFoundException, DoesntExistException
    {
        ...
        if(!admin.haveAccessTo("editPaymentType"))
        {
            response.sendRedirect(URL_PAYMENT_TYPES+"?att=noaccess");
            return;
        }
        ...
        orderSQL.updatePaymentType(paymentTypeId, statusId);
        response.sendRedirect(URL_PAYMENT_TYPES+"?att=ok");
        return;
    }
