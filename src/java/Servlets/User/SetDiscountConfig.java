 ...
 * @author Moses
 */
public class SetDiscountConfig extends HttpServlet {
private final String URL_INDEX="../index.jsp";
private final String URL_LOGIN="../Login.jsp";
private final String URL_CONFIG="Config.jsp";
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SetDiscountConfig</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SetDiscountConfig at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
            ...
            throws ServletException, IOException, SQLException, ClassNotFoundException, DoesntExistException
    {
        ...
        if(Methods.Methods.isNullOrEmpty(count,effect))
        {
            response.sendRedirect(URL_CONFIG+"?att=empty");
            return;
        }
        ...
        siteSQL.setAutoDiscountConfig(countVal, effectVal);
        response.sendRedirect(URL_CONFIG+"?att=ok");
        return;
