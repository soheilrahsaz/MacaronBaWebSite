 ...
 * @author Moses
 */
public class DeleteInperson extends HttpServlet {
...
private final String URL_USER="List/";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DeleteInperson</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet DeleteInperson at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
            ...
            throws ServletException, IOException, SQLException, ClassNotFoundException, DoesntExistException
    {
        ...
        orderHisSQL.deleteInperson(inpersonId);
        response.sendRedirect(URL_USER+userid+"?att=ok");
        return;
