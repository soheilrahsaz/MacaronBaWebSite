 ...
 * @author Moses
 */
public class GetOrderOptions extends HttpServlet {
...
//        }
        ...
        LinkedList<PaymentType> paymentTypes=orderSQL.getPaymentTypes();
        LinkedList<ShipType> shipTypes=orderSQL.getShipTypes();
        JSONObject orderOptions=new JSONObject();
        OrderJsoner jsoner=new OrderJsoner();
        orderOptions.put("shipType", jsoner.getShipTypeArray(shipTypes));
        orderOptions.put("paymentType", jsoner.getPaymentTypeArray(paymentTypes));
        JSONObject responseObject=responser.response(orderOptions, 1);
