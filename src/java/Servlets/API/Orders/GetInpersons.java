 ...
 * @author Moses
 */
public class GetInpersons extends HttpServlet {
...
//        response.setContentType("text/html;charset=UTF-8");
            ...
            throws ServletException, IOException, SQLException, ClassNotFoundException, DoesntExistException 
    {
        ...
        OrderHistorySQLCommands orderSQL=new OrderHistorySQLCommands(connection);
        LinkedList<InPerson> inperons=orderSQL.getInpersons(user.getUser().getUserId());
        OrderJsoner jsoner=new OrderJsoner();
        JSONArray inpersonObject=jsoner.getInpersonArray(inperons);
        JSONObject responseObject= responser.response(inpersonObject, 1);
