...
//        }
        ...
        LinkedList<Product> products=productSQL.getAllProductsForShowUser();
        ProductJsoner productJsoner=new ProductJsoner(connection);
        JSONArray productObject=productJsoner.getProductsJsonOnlyMainArray(products);
