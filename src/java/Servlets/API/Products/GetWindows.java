 ...
 * @author Moses
 */
public class GetWindows extends HttpServlet {
...
//        }
        ...
        LinkedList<Window> windows=productSQL.getProductWindows();
        WindowJsoner windowJsoner=new WindowJsoner(connection);
        JSONArray windowsArray=windowJsoner.getWindowsArray(windows);
        JSONObject responseObject=responser.response(windowsArray, 1);
