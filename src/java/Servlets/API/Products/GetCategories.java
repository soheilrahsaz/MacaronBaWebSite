...
//        }
        ...
        LinkedList<Category> categories=productSQL.getAllCategories();
        ProductJsoner jsoner=new ProductJsoner(connection);
        JSONArray categoryArray=jsoner.getCategoriesArray(categories);
        JSONObject responseObject=responser.response(categoryArray, 1);
