 ...
 * @author Moses
 */
public class GetPartnerReceipt extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet GetPartnerReceipt</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet GetPartnerReceipt at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
            ...
            throws ServletException, IOException, SQLException, ClassNotFoundException, DoesntExistException 
    {
        ...
        int ordreId=new JSONObject(data).optInt("orderId");
        
        PartnerSQLCommands partnerSQL=new PartnerSQLCommands(connection);
        PartnerJsoner partnerJsoner=new PartnerJsoner(connection);
        PartnerReceipt receipt=partnerSQL.getPartnerReceipt(ordreId);
        JSONObject receiptObject=partnerJsoner.getPartnerReceiptJson(receipt,partnerSafe.getPartner());
