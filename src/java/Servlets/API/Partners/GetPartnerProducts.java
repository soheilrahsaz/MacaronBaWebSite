 ...
 * @author Moses
 */
public class GetPartnerProducts extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet GetPartnerProducts</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet GetPartnerProducts at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
//        }
        ...
        LinkedList<PartnerProduct> products=partnerSQL.getPartnerProducts();
        PartnerJsoner partnerJsoner=new PartnerJsoner(connection);
        JSONArray productsArray=partnerJsoner.getPartnerProductsArray(products,partnerSafe.getPartner());
        out.println(responser.response(productsArray, 1));
    }
}
