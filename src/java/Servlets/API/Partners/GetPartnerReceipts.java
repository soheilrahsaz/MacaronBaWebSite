 ...
 * @author Moses
 */
public class GetPartnerReceipts extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet GetPartnerReceipts</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet GetPartnerReceipts at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
//        }
        ...
        LinkedList<PartnerReceipt> receipts=partnerSQL.getPartnerReceipts(partnerSafe.getPartner().getPartnerId());
        JSONArray receiptsArray=partnerJsoner.getPartnerReceiptArray(receipts,partnerSafe.getPartner());
        out.println(responser.response(receiptsArray, 1));
    }
}
