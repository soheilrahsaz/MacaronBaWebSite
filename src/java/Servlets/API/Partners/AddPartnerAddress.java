...
import Methods.API.User.UserObjector;
 ...
 * @author Moses
 */
public class AddPartnerAddress extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AddPartnerAddress</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AddPartnerAddress at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
            ...
            throws ServletException, IOException, SQLException, ClassNotFoundException, DoesntExistException 
    {
        ...
        UserObjector userObjector=new UserObjector();
        UserAddress address=userObjector.getAddress(dataObject);
        PartnerSQLCommands partnerSQL=new PartnerSQLCommands(connection);
        partnerSQL.addPartnerAddress(partnerSafe.getPartner().getPartnerId(), address.getAddress(), address.getPostalCode(), address.getPhoneNumber());
