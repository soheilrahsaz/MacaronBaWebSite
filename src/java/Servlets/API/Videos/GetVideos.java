...
//        }
        ...
        LinkedList<Video> videos=siteSQL.getVideosApproved();
        VideosJsoner jsoner=new VideosJsoner();
        JSONArray videosArray=jsoner.getVideosArray(videos);
        JSONObject responseObject=responser.response(videosArray, 1);
