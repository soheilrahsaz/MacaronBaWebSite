...
public class AddAddress extends HttpServlet {
            ...
            throws ServletException, IOException, SQLException, ClassNotFoundException, DoesntExistException 
    {
        ...
        UserAddress address=userObjector.getAddress(new JSONObject(data));
        UserSQLCommands userSQL=new UserSQLCommands(connection);
        userSQL.addAddress(user.getUser().getUserId(), address.getAddress(), address.getPostalCode(), address.getPhoneNumber()
                ,address.getLatitude(),address.getLongitude());
        JSONObject responseobObject=responser.response(1);
        out.println(responseobObject.toString());
