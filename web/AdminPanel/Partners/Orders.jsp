<%-- 
    Document   : Orders
    Created on : Sep 9, 2018, 7:16:16 AM
    Author     : Moses
--%>

<%@page import="Objects.Printers.AdminPanel.Partners"%>
<%@page import="Objects.Partner.Partner"%>
<%-- 
    Document   : Partners
    Created on : Sep 9, 2018, 7:15:06 AM
    Author     : Moses
--%>
...
<%
    ...
    if(!admin.haveAccessTo("orderPartner"))
    {
        connection.close();
...
<head>
  ...
  <title>لیست سفارشات همکاران</title>
              ...
              <table class="table table-hover">
                ...
                <%
                    try {
                           ...
                           out.println(partners.getOrdersList(request));
                        } catch (Exception e) {
                            out.println(e.getMessage());
                        }
                    %>
