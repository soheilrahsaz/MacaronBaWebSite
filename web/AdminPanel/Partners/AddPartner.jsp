<%-- 
    Document   : AddPartner
    Created on : Sep 9, 2018, 7:15:18 AM
    Author     : Moses
--%>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">افزودن همکار</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="AddPartner" >
              <div class="box-body">
                  ...
                  <select class="form-control" name="series">
                      <%
                          ...
                          out.println(partners.getPartnerSeriesOptions());
                          %>
                  </select>
                </div>
