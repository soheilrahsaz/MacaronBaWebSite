<%-- 
    Document   : PartnerSeries
    Created on : Oct 19, 2018, 8:45:17 AM
    Author     : Moses
--%>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="AddPartnerSeries">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="number" min="0" max="100" step="0.01" name="effect" class="form-control"  placeholder="تاثیر قیمت">
                </div>
              </div>
              <!-- /.box-body -->
              ...
              <table class="table table-hover">
                ...
                <%
                    try {
                            ...
                            out.println(partners.getPartnerSeriesRows());
                        } catch (Exception e) {
