<%-- 
    Document   : AddProduct
    Created on : Sep 9, 2018, 12:31:50 PM
    Author     : Moses
--%>
...
<head>
  ...
  <title>افزودن محصول همکار</title>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">افزودن به ویترین</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="AddPartnerProduct" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  <label>دسته بندی</label>
                  <select name="category" class="form-control">
                      <%
                          Partners partners=new Partners(connection);
                          out.println(partners.getCategoriesOptions());
                          %>
                  </select> 
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                  <label >قیمت</label>
                  <input type="number" name="price" min="0" class="form-control"  placeholder="قیمت">
                </div>
                  
                  <div class="form-group">
                  <label >تعداد موجود</label>
                  <input type="number" name="count" min="0" class="form-control"  placeholder="تعداد">
                </div>
