<%-- 
    ...
    Created on : Jul 17, 2018, 5:14:04 PM
    Author     : Moses
--%>

<%@page import="Objects.Admin.Admin"%>
<%@page import="Objects.Printers.AdminPanel.Invoice"%>
...
<%
    ...
    if(!admin.haveAccessTo("viewPayment"))
    {
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">افزودن روش</h3>
            </div>
             /.box-header 
             form start 
            <form role="form" method="post" action="AddShipType">
              <div class="box-body">
                <div class="form-group">
                  <label >نام روش</label>
                  <input type="text" name="name" class="form-control"  placeholder="نام روش">
                </div>
                <div class="form-group">
                  <label>توضیحات</label>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">روش های پرداخت</h3>
              ...
              <table class="table table-hover">
                ...
                <%
                    try {
                            ...
                            out.println(invoice.getPaymentTypeRows());
                        } catch (Exception e) {
