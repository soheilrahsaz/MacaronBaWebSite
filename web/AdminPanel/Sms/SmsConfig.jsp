<%-- 
    Document   : SmsConifg
    Created on : Jul 26, 2018, 2:18:02 PM
    Author     : Moses
--%>
...
<head>
  ...
  <title>ویرایش تنظیمات پیامک</title>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">تنظیمات پنل اس ام اس</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="SetSmsConfig" >
              <div class="box-body">
                 ...
                 <div class="form-group">
                     ...
                     <%
                         ...
                         out.println(sms.getSmsConfigCheckBox());
                             } catch (Exception e) {
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="SetAdminPhoneNumber" >
              <div class="box-body">
                
               
                 <div class="form-group">
                     <label>شماره مدیر</label>
                     <input type="text" class="form-control" name="phoneNumber" value="<%=sms.getAdminPhone()%>">
