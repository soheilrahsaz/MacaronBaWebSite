<%-- 
    Document   : Sections
    Created on : Jul 26, 2018, 12:56:29 PM
    Author     : Moses
--%>
...
<head>
  ...
  <title>قسمت بندی ویدیو ها</title>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">اضافه کردن بخش</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="AddSection">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label >نام بخش</label>
                  <input type="name" name="name" class="form-control"  placeholder="نام بخش">
                </div>
              ...
              <table class="table table-hover">
                ...
                <%
                    try {
                            ...
                            out.println(site.getSectionRows());
                        } catch (Exception e) {
