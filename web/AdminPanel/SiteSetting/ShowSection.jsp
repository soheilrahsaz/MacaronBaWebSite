<%-- 
    Document   : ShowSection
    Created on : Jul 29, 2018, 1:25:46 PM
    Author     : Moses
--%>
...
<%
    ...
    if(!admin.haveAccessTo("editSection"))
    {
        connection.close();
...
<head>
  ...
  <title>نمایش قسمت بندی ویدیو</title>
  ...
  <div class="content-wrapper">
          ...
          <%
              try {
                    ...
                    out.println(site.showSection(uri));
                  } catch (Exception e) {
