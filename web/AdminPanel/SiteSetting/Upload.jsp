<%-- 
    Document   : Upload
    Created on : Jul 26, 2018, 7:27:04 AM
    Author     : Moses
--%>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="AddVideo" enctype="multipart/form-data">
              <div class="box-body">
                  ...
                  <select class="form-control" name="sectionId">
                      <%  
                        ...
                        out.println(site.getSectionOptions());
                      %>
                  </select>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="name" class="form-control"  placeholder="نام فیلم">
                </div>
                  ...
                  <input type="text" name="tags" class="form-control"  placeholder=" تگ فیلم">
                </div>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">اپلود ها</h3>
              ...
              <table class="table table-hover">
                ...
                <%
                    try {
                            ...
                            out.println(site.getViedosRows());
                        } catch (Exception e) {
