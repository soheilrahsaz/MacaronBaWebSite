<%-- 
    ...
    Created on : Sep 13, 2018, 9:58:48 AM
    Author     : Moses
--%>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" enctype="multipart/form-data" method="post" action="AddAdvertisment">
              <div class="box-body">
              ...
              <table class="table table-hover">
                ...
                <%
                    try {
                            ...
                            out.println(sitesetting.getAdvertismentRows());
                        } catch (Exception e) {
