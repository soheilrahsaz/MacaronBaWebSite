<%-- 
    Document   : MainVideo
    Created on : Jul 26, 2018, 12:46:22 PM
    Author     : Moses
--%>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">اپلود فیلم صفحه اصلی</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="SetMainVideo" enctype="multipart/form-data">
              <div class="box-body">
