<%-- 
    Document   : SiteInfo
    Created on : Aug 16, 2018, 12:45:27 AM
    Author     : Moses
--%>

<%@page import="SQL.Commands.SiteSettingSQLCommands"%>
<%@page import="java.util.HashMap"%>
<%@page import="Objects.Printers.AdminPanel.Communications"%>
...
<head>
  ...
  <title>اطلاعات نمایشی سایت</title>
  ...
  <div class="content-wrapper">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"> اطلاعات نمایشی سایت</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="SetSiteInfo">
              <div class="box-body">
                  <%
                      HashMap<String,String> data=new SiteSettingSQLCommands(connection).getSiteInfo();
                      %>
                  
                      <div class="form-group">
                  <label >درباره ما</label>
                  <textarea name="aboutUs" class="form-control" rows="6" placeholder="آدرس"><%=data.get("aboutUs")%></textarea>
                </div>
                
                  <div class="form-group">
                  <label >آدرس</label>
                  <textarea name="address" class="form-control" rows="3" placeholder="آدرس"><%=data.get("address")%></textarea>
                </div>
                  
                  <div class="form-group">
                  <label >شماره تماس</label>
                  <input type="text" name="phoneNumber" class="form-control" placeholder="شماره تماس" value="<%=data.get("phoneNumber")%>" />
                </div>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">لینک ها</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="SetLinksStatus" >
                     ...
                     out.println(siteSetting.getLinksStatus());
