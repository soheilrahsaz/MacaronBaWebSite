<%-- 
    Document   : Config
    Created on : Aug 4, 2018, 3:13:00 PM
    Author     : Moses
--%>

<%@page import="SQL.Commands.SiteSettingSQLCommands"%>
<%@page import="java.util.HashMap"%>
<%@page import="Objects.Printers.AdminPanel.Sms"%>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">افزودن کد تخفیف برای دعوت</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <%
                HashMap<String,String> data=new SiteSettingSQLCommands(connection).getAutoDiscountConfig();
                %>
            <form role="form" method="post" action="SetDiscountConfig" >
              <div class="box-body">
                
               
                 <div class="form-group">
                  <label >بعد از تعداد دعوت</label>
                  <input type="number" min="0"  name="count" class="form-control"  placeholder="تعداد" value="<%=data.get("inviteDiscountCount") %>">
                </div>
                  
                  <div class="form-group">
                  <label >درصد تخفیف</label>
                  <input type="number" min="0" max="100" step="0.01"  name="effect" class="form-control"   placeholder="درصد تخفیف"  value="<%=data.get("inviteDiscountEffect") %>">
                </div>
