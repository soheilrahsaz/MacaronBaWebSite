<%-- 
    Document   : ShowOrder
    Created on : Jul 12, 2018, 11:45:11 AM
    Author     : Moses
--%>


<%@page import="Objects.Admin.Admin"%>
<%@page import="Objects.Printers.AdminPanel.Orders"%>
...
<%
    ...
    if(!admin.haveAccessTo("viewOrder"))
    {
  ...
  <div class="content-wrapper">
          ...
          <%
              try {
                    ...
                    out.println(orders.printShowOrder(request.getRequestURI()));
