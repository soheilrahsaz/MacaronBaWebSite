<%-- 
    Document   : Texts
    Created on : Sep 9, 2018, 1:37:35 PM
    Author     : Moses
--%>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">افزودن مطلب</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="AddText">
                
              <div class="box-body">
                  
                <div class="form-group">
                  <label >نام مطلب</label>
                  <input type="text" name="subject" class="form-control"  placeholder="نام  مطلب">
                </div>
            ...
            <div class="box-body pad">
                ...
                <textarea name="text" id="mytextarea" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
          ...
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <%
                    try {
                            Communications com=new Communications(connection);
                            out.println(com.getTextRows());
                        } catch (Exception e) {
