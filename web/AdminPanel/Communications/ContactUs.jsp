<%-- 
    Document   : ContactUs
    Created on : Jul 26, 2018, 1:14:16 PM
    Author     : Moses
--%>
...
<head>
  ...
  <title>اطلاعات ارتباط با ما</title>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"> متن صفحه تماس با ما</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="SetConactUs">
              <div class="box-body">
                  
                  <div class="form-group">
                  <label >متن</label>
                  <textarea name="text" class="form-control" rows="3" placeholder="متن"><%
                          SiteSetting site=new SiteSetting(connection);
                          out.print(site.getContactUs());
                          %></textarea>
                </div>
              ...
              <table class="table table-hover">
                ...
                <%
                    try {
                           ...
                           out.println(com.getMessageRows());
                        } catch (Exception e) {
