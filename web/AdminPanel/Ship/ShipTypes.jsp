<%-- 
    Document   : ShipTypes
    Created on : Jul 16, 2018, 7:04:01 PM
    Author     : Moses
--%>
...
<%
    ...
    if(!admin.haveAccessTo("viewShip"))
    {
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">روش های حمل و نقل</h3>
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <%
                    try {
                            Ships ships=new Ships(connection);
                            out.println(ships.getShipTypeRows());
                        } catch (Exception e) {
