<%-- 
    Document   : Window
    Created on : Jul 18, 2018, 8:07:21 AM
    Author     : Moses
--%>
...
<%
    ...
    if(!admin.haveAccessTo("viewWindow"))
    {
...
<head>
  ...
  <title>لیست محصولات ویترین</title>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">لیست محصولات ویترین</h3>
              ...
              <table class="table table-hover">
                ...
                <%
                    try {
                            ...
                            out.println(products.getProductWindowRows());
                        } catch (Exception e) {
