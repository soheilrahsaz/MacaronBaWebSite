<%-- 
    Document   : ColorMap
    Created on : Sep 17, 2018, 7:49:55 AM
    Author     : Moses
--%>

<%-- 
    Document   : Categories
    Created on : Sep 9, 2018, 12:48:49 PM
    Author     : Moses
--%>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">افزودن طعم</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="AddColorMap">
              <div class="box-body">
                  
                <div class="form-group">
                  <label >نام طعم</label>
                  <input type="text" name="taste" class="form-control"  placeholder="نام طعم">
                </div>
                  ...
                  <select name="color" class="form-control">
                      <%
                          ...
                          out.println(products.getColorOptions());
                          %>
                  </select> 
                </div>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">رنگ بندی ها</h3>
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <%
                    try {
                            out.println(products.getColorMapRows());
                        } catch (Exception e) {
