<%-- 
    Document   : AddProductWindow
    Created on : Jul 18, 2018, 8:07:13 AM
    Author     : Moses
--%>
...
<head>
  ...
  <title>افزودن محصول به ویترین</title>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="AddWindow" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <select name="category" class="form-control">
                      <%
                          ...
                          out.println(products.getCategoryOptionsValues());
                          %>
                  </select> 
                </div>
